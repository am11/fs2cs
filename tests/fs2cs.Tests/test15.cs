...
public class Test15 {
    public static dynamic SimpleArithmetic() {
        return new Func<Func<dynamic, dynamic>>(() =>
        {
            dynamic x = 10 + 12 - 3;
            dynamic y = x * 2 + 1;
            ...
            return () => new Func<Func<dynamic, dynamic>>(() =>
            {
                ...
                return (arg10) => new Func<Func<dynamic, dynamic>>(() =>
                {
                    Func<dynamic, dynamic, dynamic, dynamic> clo2 = clo1(arg10);
                    return (arg20) => new Func<Func<dynamic, dynamic>>(() =>
                    {
                        Func<dynamic, dynamic, dynamic> clo3 = clo2(arg20);
                        return (arg30) => new Func<Func<dynamic, dynamic>>(() =>
                        {
